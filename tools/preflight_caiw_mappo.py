...
def main():
    ...
    checks={
      ...
      "common_init_rng_exact":a.rng.bit_generator.state==c.rng.bit_generator.state,"enabled_modules_exact":enabled==expected,"reward_hash_identical":config_sha256(env["reward"])==config_sha256(env["reward"]),"blue_hash_identical":config_sha256(env["blue_policy"])==config_sha256(env["blue_policy"]),"weapon_hash_identical":config_sha256(env["weapon"])==config_sha256(env["weapon"]),
