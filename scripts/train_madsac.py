...
def main()->None:
    ...
    env_cfg=yaml.safe_load((root/"configs/combat_environment.yaml").read_text(encoding="utf-8")); alg_cfg=yaml.safe_load((root/"configs/madsac.yaml").read_text(encoding="utf-8"))
