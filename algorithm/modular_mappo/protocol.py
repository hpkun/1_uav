...
def validate_modular_checkpoint(state,env_config,algorithm_config,expected_runtime=None):
 ...
 if state.get("modular_mappo_impl_version")!=MODULAR_MAPPO_IMPL_VERSION:raise RuntimeError("modular implementation version mismatch")
...
__all__=["canonical_sha256","checkpoint_architecture","validate_modular_checkpoint"]
